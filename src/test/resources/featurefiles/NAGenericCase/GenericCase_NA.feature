Feature: Generic Case NA
  ...
  Scenario Outline: Create a Generic case manually from start search customer using Start research.
    ...
    Examples: 
      ...
      | MohanNA.CFS | April@2020 | Customers |     0030004423 | Generic Case | Order Entry | RDD   | RDD Change - Compliance | 0001-    | 10-         | 40-      | abhinash kotikalapudi | Manikumar Kosireddi | Resolved-Completed |
