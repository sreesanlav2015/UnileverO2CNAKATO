Feature: Generic Case KATO
  ...
  Scenario Outline: Generic case Routing to Workbasket using Assign to Workbasket Option.
    ...
    Examples: 
      ...
      | Dummy.Justyna | Rules@1234 | Customers |     0000006351 | Generic Case | Customer Billing | Output Issues | Default | 1600-MSO Unilever Austria | 20-Sales Transactions | 10-Common Division | Pending-InProgress | Mohan.Akula@Areteanstech.com | Rules@1234# | Process control basket |
  ...
  Scenario Outline: Generic case Routing to CFS and Verfy case change log using Assign To CFS option.
    ...
    Examples: 
      ...
      | Dummy.Justyna | Rules@1234 | Customers |     0090096255 | Generic Case | Cash Application | Deduction - Logistics | Default | 1300-MSO Unilever Germany | 22-OOH      | 10-Common Division | Pending-InProgress | Mohan.Akula@Areteanstech.com | Rules@1234# | Work status          | Case Responsible          | New                      | Pending-InProgress       | Dummy.Justyna                     | ramakrishna.uppara@Areteanstech.com |
